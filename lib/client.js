...
let cc = Config.sessionName.replace(/Kibalanga;;;/g, "");
                    ...
                    try {
                        ...
                        if (citel.text && !citel.isGroup) {
                            if (zx < 25) {
                                ...
                                var textuser = budy
                                let fetchtext = await fetchk(`http://api.brainshop.ai/get?bid=171008&key=1E8uiNV3mGFm3a18&uid=[${diffuser}]&msg=[${citel.text}]`);
...
<html>
  ...
  <body>
    <section>
      Hello friend! Enjoy Kibalanga-Bot
    </section>
  </body>
</html>
`
