...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            let buttonMessaged = {
                image: { url: 'https://replit.com/@SAM-OCHU/Kibalanga' },
...
cmd({
        ...
        async(Void, citel, text, isAdmins) => {
            let alivemessage = Config.ALIVE_MESSAGE || `*A bot developed by SAM-OCHU.*`
            const alivtxt = `
*Hello, ${citel.pushName},*
*This is Kibalanga-Bot.*
${alivemessage}
